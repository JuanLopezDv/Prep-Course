...
function saludo(idioma) {
  ...
  // Tu código:
  let idiomas1 = ["aleman", "mandarin", "ingles"];
  let hablados1 = ["Guten Tag!", "Ni Hao!", "Hello!"];
  for(let i = 0; i < 3; i++){
    if(idioma == idiomas1[i]) return hablados1[i];
  }
  return "Hola!";
}
...
function esPrimo(numero) {
  ...
  if (numero < 2 || numero % 2 == 0 || numero % 3 ==0) return false;
  return true;
  }
